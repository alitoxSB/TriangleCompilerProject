...
public class Parser {
  ...
  private SourcePosition commandPos;
  private ForCommand commandAST;
  ...
  Command parseSingleCommand() throws SyntaxError {
    ...
    switch (currentToken.kind) {
      ...
      case Token.PUT:
      {
        ...
        accept(Token.RPAREN);
        finish(commandPos);
        commandAST = new PutCommand(vAST, eAST, e2AST, commandPos);
      }
      break;
      ...
      case Token.FOR:
      {
        ...
        Command cAST = parseSingleCommand();
        finish(commandPos);
        commandAST = new ForCommand(vAST, iAST,i2AST, cAST, commandPos);
      }
      break;
